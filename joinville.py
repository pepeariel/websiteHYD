...
layout = dbc.Container([dbc.Row([
    dbc.Col([
        ...
        html.Br(),
        dcc.Dropdown(id= 'pressao_joinville_tipo',
                             options=[
...
@app.callback(
    ...
    [
        ...
        Input(component_id='pressao_joinville_tipo',component_property='value'),
...
# TITULO DO GRÁFICO DINÂMICO
    ...
    if start_date and end_date is not None:
        ...
        if len(dff2) > 0:
            ...
            return funcoes.arrumadb(db_pressao_joinville_a, value, titulo)
    else:
        return funcoes.arrumadb(db_pressao_joinville_a, value, titulo)
